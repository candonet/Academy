<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TouristCat.aspx.cs" Inherits="TouristCat" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>جاذبه های گردشگری</title>
</asp:Content>
                        ...
                        <table style="height: 94px;width: 100%;">
                            <tr >
                                <td style="height: 31px;">
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# Eval("JazebeProfile","~/Jazebe/{0}") %>' Text='<%# Eval("Title") %>' style="text-decoration:none;color:#5e88fc;font-size:14px"></asp:HyperLink>
                                </td>
                            </tr>
                            <tr>
