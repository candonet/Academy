...
public partial class Admin_AddHotel : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        if (TextBox1.Text.Trim() != "" && (TextBox3.Text.Trim() != "" || FileUpload2.HasFile)  && HotelName.Text.Trim() != "" && Tozihat.Text.Trim() != "")
        {
            ...
            try
            {
                ...
                {
                    Label1.Text = "نام این پروفایل در سیستم موجود می باشد";
                    Label1.ForeColor = Color.Red;
                }
            }
            catch (Exception exp)
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        ...
        //{
        //    Label5.Text = "";
        //    Label6.Text = "هیچ فایلی برای آپلود انتخاب نشده است";
        //    Label5.ForeColor = Color.Red;
        //}
    }
    ...
    protected void Button6_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            SqlCommand cmd = new SqlCommand("UPDATE Hotel Set Active = 1 where id = " + Session["HotelID"].ToString(), con);
            con.Open();
            cmd.ExecuteNonQuery();
            con.Close();
            GridView1.DataBind();
    ...
    protected void Button7_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            SqlCommand cmd = new SqlCommand("UPDATE Hotel Set Active = 0 where id = " + Session["HotelID"].ToString(), con);
            con.Open();
            cmd.ExecuteNonQuery();
            con.Close();
            GridView1.DataBind();
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            SqlCommand cmd = new SqlCommand("INSERT INTO InfoHotel(Nam) Values(" + CheckNull(TextBox2.Text,1) + ")", con);
            con.Open();
            cmd.ExecuteNonQuery();
            con.Close();
            MessageBox("مشخصه جدید با موفقیت اضافه شد");
            TextBox2.Text = "";
            LoadHotelInfoList();
        }
        catch { }
    ...
    protected void DropDownList2_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            string[] Data = DropDownList2.Text.Split('-');
            SqlDataSource1.SelectCommand = "SELECT [ID], [Title],[Active] FROM [Hotel] WHERE [Country] = " + Data[0];
            GridView1.DataBind();
        }
        else
        {
            SqlDataSource1.SelectCommand = "SELECT [ID], [Title],[Active] FROM [Hotel]";
            GridView1.DataBind();
        }
    }
    protected void DropDownList6_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (DropDownList6.Text != "نامشخص")
        {
            ...
            SqlDataSource1.SelectCommand = "SELECT [ID], [Title],[Active] FROM [Hotel] WHERE [Country] = " + Data[0] + " AND [City] = " + Data2[0];
            GridView1.DataBind();
        }
        else
        {
    ...
    protected void Button8_Click(object sender, EventArgs e)
    {
        ...
        {
            SqlDataSource1.SelectCommand = "SELECT [ID], [Title],[Active] FROM [Hotel] WHERE [Title] like N'%" + SearchHotel.Text.Trim().ToLower() + "%'";
            GridView1.DataBind();
        }
        else
        {
