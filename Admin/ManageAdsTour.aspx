<%@ Page Title="" MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="ManageAdsTour.aspx.cs" Inherits="Admin_ManageADS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <form id="Form1" runat="server">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="ID" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Width="500px" OnRowUpdating="GridView1_RowUpdating" OnRowDataBound="GridView1_RowDataBound">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MyConString %>" DeleteCommand="DELETE FROM [AdsTour] WHERE [ID] = @original_ID " InsertCommand="INSERT INTO [AdsTour] ([ImageADR]) VALUES (@ImageADR)" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [AdsTour]" UpdateCommand="UPDATE [AdsTour] SET [ImageADR] = @ImageADR WHERE [ID] = @original_ID AND (([ImageADR] = @original_ImageADR) OR ([ImageADR] IS NULL AND @original_ImageADR IS NULL))" OnUpdating="SqlDataSource1_Updating">
                        <DeleteParameters>
