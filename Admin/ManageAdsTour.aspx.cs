...
public partial class Admin_ManageADS : System.Web.UI.Page
{
    ...
    protected void Button5_Click(object sender, EventArgs e)
    {
        if (TextBox1.Text.Trim() != "" && TextBox3.Text.Trim() != "" && TextBox4.Text.Trim() != "" && TextBox5.Text.Trim() != "" && (TextBox2.Text.Trim() != "" || FileUpload1.HasFile == true))
        {
            ...
            try
            {
                ...
                myQu = "INSERT INTO AdsTour(ImageADR,URL,KeyW,StartDate,EndDate,AdsName) VALUES(N'" + TextBox2.Text.Trim() + "',N'" + URLLL + "',N'" + TextBox6.Text.Trim() + "',N'" + StartDate  + "',N'" + EndDate + "',N'" + TextBox5.Text.Trim() +"');";
    ...
    protected void ShowAdsInfo(string AdsID)
    {
        ...
        try
        {
            SqlCommand cmd = new SqlCommand("select AdsName,ImageADR,URL,StartDate,EndDate,KeyW,ID From AdsTour WHERE ID =" + AdsID, con);
    ...
    protected void Button6_Click(object sender, EventArgs e)
    {
        if (TextBox1.Text.Trim() != "" && TextBox3.Text.Trim() != "" && TextBox4.Text.Trim() != "" && TextBox5.Text.Trim() != "" && (TextBox2.Text.Trim() != "" || FileUpload1.HasFile == true))
        {
            ...
            try
            {
                ...
                myQu = "Update ADSTour SET ImageADR = N'" + TextBox2.Text.Trim() + "',URL = N'" + URLLL + "',KeyW = N'" + TextBox6.Text.Trim() + "',StartDate = '" + StartDate + "',EndDate ='" + EndDate + "',AdsName=N'" + TextBox5.Text.Trim() + "' WHERE ID = " + Session["AdsTourID"].ToString() ;
                cmd.CommandText = myQu;
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
