<%@ Page Title="" Language="C#" MaintainScrollPositionOnPostback="true" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="AgencyComment.aspx.cs" enableEventValidation="false" Inherits="Admin_AgencyComment" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>مدیریت پیام های آژانس</title>
    <style>
        .TaedNashode
        {
            font-size:13.5px;
