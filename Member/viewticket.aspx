<%@ Page Title="" Language="C#" MasterPageFile="~/Member/Member.master" AutoEventWireup="true" CodeFile="viewticket.aspx.cs" Inherits="Member_viewticket" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h2>مشاهده تیکت <asp:Label ID="Label1" runat="server" Text="#" Font-Names="Tahoma"></asp:Label></h2>
