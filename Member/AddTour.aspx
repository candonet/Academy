<%@ Page Title="" Language="C#" MasterPageFile="~/Member/Member.master"  MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="AddTour.aspx.cs" Inherits="Member_AddTour" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <form id="Form1" runat="server">
        ...
        <table style="width:100%">
            <tr>
                <td>
                    نوع تور<asp:DropDownList ID="DropDownList12" runat="server" Width="120px" AutoPostBack="True"></asp:DropDownList>
                </td>
                <td>
        ...
        <asp:GridView ID="GridView3" runat="server" AllowPaging="True" AutoGenerateColumns="False"  Width="800px" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" GridLines="Horizontal" OnRowUpdating="GridView3_RowUpdating" OnSelectedIndexChanged="GridView3_SelectedIndexChanged" OnPageIndexChanged="GridView3_PageIndexChanged" OnPageIndexChanging="GridView3_PageIndexChanging" OnRowDataBound="GridView3_RowDataBound" >
            <Columns>
                ...
                <asp:TemplateField ShowHeader="False">
                    <ItemTemplate>
                        <asp:Button ID="LinkButton9" runat="server" CausesValidation="False" CommandName="Update" Text="بررسی"></asp:Button>
                    </ItemTemplate>
                ...
                <td>
                    <table style="width: 400px;">
                        ...
                        <tr>
                            ...
                            <td class="auto-style10">
                                <asp:DropDownList ID="DropDownList10" runat="server" Font-Names="BYekan" Font-Size="Small" Height="100%" Width="60px" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                        ...
                        <tr>
                            ...
                            <td class="auto-style12">
                                ...
                                &nbsp;<asp:Button ID="Button5" runat="server" Text="حذف" OnClick="Button5_Click" OnClientClick="return confirm('آیا شما مطمئن به حذف هستید؟'); "/>
                                </td>
                        </tr>
                        <tr>
     ...
     <h2 id="HotelTitle" runat="server">هتل ها</h2>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="ID" DataSourceID="SqlDataSource1" OnRowDeleting="GridView1_RowDeleting" OnRowUpdating="GridView1_RowUpdating" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="1100px" OnRowDataBound="GridView1_RowDataBound">
            <Columns>
                <asp:TemplateField ShowHeader="False">
                    <ItemTemplate>
                        <asp:Button ID="LinkButton1" runat="server" CausesValidation="False" CommandName="Delete" Text="حذف" OnClientClick="return confirm('آیا شما مطمئن به حذف هستید؟'); "></asp:Button>
        ...
        <table style="width:750px;" runat="server" id="TableHotel">
            <tr>
                <td id="sl1" runat="server" class="auto-style17">نام هتل :</td>
                <td id="sl4" runat="server" class="auto-style21">
            ...
            <tr id="sl2" runat="server">
                <td class="auto-style17">نام هتل :</td>
            ...
            <tr id="sl3" runat="server">
                <td class="auto-style17">تعداد ستاره :</td>
                <td class="auto-style21">
                    <asp:DropDownList ID="DropDownList9" runat="server" Font-Names="Tahoma" Height="100%" Width="48px" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
            ...
            <tr>
                <td class="auto-style17">خدمات :</td>
                <td class="auto-style21">
            ...
            <tr id="sln21" runat="server">
                ...
                <td>
                    کشور : <asp:DropDownList ID="DropDownList34" runat="server" Width="167px" OnSelectedIndexChanged="DropDownList33_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
                </td>
            </tr>
            ...
            <tr id="sln31" runat="server">
                ...
                <td>
                    کشور : <asp:DropDownList ID="DropDownList35" runat="server" Width="167px" OnSelectedIndexChanged="DropDownList33_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
                </td>
            </tr>
            ...
            <tr id="sln41" runat="server">
                ...
                <td>
                    کشور : <asp:DropDownList ID="DropDownList36" runat="server" Width="167px" OnSelectedIndexChanged="DropDownList33_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
                </td>
            </tr>
            ...
            <tr>
                <td class="auto-style17">قيمت 2 تخته (هر نفر) :</td>
                <td class="auto-style21">
                    <asp:TextBox ID="Qeimat1" runat="server" Width="196px"></asp:TextBox>
                </td>
                <td>

                    قیمت اضافه:<asp:TextBox ID="Qeimat1P" runat="server"></asp:TextBox>
            ...
            <tr>
                <td class="auto-style17">قیمت ۱ تخته (هر نفر) :</td>
                <td class="auto-style21">
                    <asp:TextBox ID="Qeimat2" runat="server" Width="196px"></asp:TextBox>
                </td>
                <td>

                    قیمت اضافه:<asp:TextBox ID="Qeimat2P" runat="server"></asp:TextBox>
            ...
            <tr>
                <td class="auto-style17">کودک با تخت ۶ تا ۱۲ سال :</td>
                <td class="auto-style21">
                    <asp:TextBox ID="Qeimat3" runat="server" Width="196px" OnTextChanged="TextBox2_TextChanged"></asp:TextBox>
                </td>
                <td>

                    قیمت اضافه:<asp:TextBox ID="Qeimat3P" runat="server"></asp:TextBox>
            ...
            <tr>
                <td class="auto-style17">کودک بدون تخت ۲ تا ۶ سال :</td>
                <td class="auto-style21">
                    <asp:TextBox ID="Qeimat4" runat="server" Width="196px"></asp:TextBox>
                </td>
                <td>
                    قیمت اضافه:<asp:TextBox ID="Qeimat4P" runat="server"></asp:TextBox>
            ...
            <tr>
                <td class="auto-style20">توضیحات :</td>
                <td class="auto-style21">
            ...
            <tr>
                ...
                <td class="auto-style22">
                    <asp:Button ID="Button7" runat="server" OnClick="Button7_Click" Text="درج جدید"/>
	...
	FROM [TourHotel] WHERE ([TourID] = @TourID)" UpdateCommand="UPDATE [TourHotel] SET [HotelID] = @HotelID, [qeimat1] = @qeimat1, [qeimat2] = @qeimat2, [qeimat3] = @qeimat3, [qeimat4] = @qeimat4, [tozihat] = @tozihat, [TourID] = @TourID WHERE  [TourID] = @original_TourID">
            <DeleteParameters>
                <asp:Parameter Name="original_ID" Type="Int64" />
